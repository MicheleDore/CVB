...
router.post("/api/update/:comment", updateComment)/*ce controlleur met à jour en BDD le commentaire laissé par l'utilisateur*/
router.post("/api/delete/:comment", deleteComment)/*ce controlleur permet d'effacer un commentaire en BDD*/
